        ...
        <div className="flex flex-col items-center opacity-0 translate-y-10 transition-all duration-1000">
          <div className="mb-12 text-center">
            <div className="pulse-chip mb-4">
              ...
              <span>Conheça o Futuro</span>
            </div>
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-4">
              Engenharia de Precisão Encontra <span className="text-[#FC4D0A]">IA Adaptativa</span>
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Nosso robô humanóide representa a fusão perfeita entre engenharia mecânica de ponta e 
              inteligência artificial de última geração, projetado para se integrar perfeitamente aos ambientes humanos.
            </p>
          </div>
          ...
          <div className="relative w-full max-w-4xl overflow-hidden rounded-3xl shadow-2xl">
            <img 
              ...
              alt="Robô humanóide avançado com exterior branco" 
              className="w-full object-cover"
            />
            <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/70 to-transparent p-8">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-white text-xl font-semibold">Companheiro de Próxima Geração</h3>
                  <p className="text-white/80">Projetado para interação humana</p>
                </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12">
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Sensores Avançados</h4>
              <p className="text-gray-600">Sensores de alta precisão fornecem consciência ambiental em tempo real e reconhecimento de objetos.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Aprendizado Adaptativo</h4>
              <p className="text-gray-600">Aprende continuamente com as interações para melhorar o desempenho e personalizar respostas.</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-xl shadow-elegant hover:shadow-elegant-hover transition-all duration-300">
              ...
              <h4 className="text-lg font-semibold mb-2">Movimento Fluido</h4>
              <p className="text-gray-600">Projetado para movimento natural, semelhante ao humano, com altos graus de liberdade em todas as articulações.</p>
            </div>
          </div>
        </div>
      </div>
