      ...
      <div className="section-container">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <p className="section-subtitle mx-auto opacity-0 fade-in-element">
            Construído com tecnologia de ponta para entender, aprender e se adaptar às suas necessidades únicas.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="O Atlas aprende com suas interações, melhorando continuamente suas respostas e ações para atender melhor às suas necessidades."
            index={0}
          />
          <FeatureCard
            ...
            description="Comunique-se usando linguagem natural e gestos. O Atlas entende o contexto e responde adequadamente."
            index={1}
          />
          <FeatureCard
            ...
            description="Articulações motorizadas avançadas proporcionam movimentos fluidos e semelhantes aos humanos, com equilíbrio e coordenação excepcionais."
            index={2}
          />
          <FeatureCard
            ...
            description="Sensores avançados e tecnologia de mapeamento permitem que o Atlas navegue em ambientes complexos com facilidade."
            index={3}
          />
          <FeatureCard
            ...
            description="Protocolos integrados protegem seus dados e privacidade, enquanto salvaguardas físicas garantem uma operação segura."
            index={4}
          />
          <FeatureCard
            ...
            description="De simples lembretes a tarefas complexas de várias etapas, o Atlas pode auxiliar em uma ampla gama de atividades."
            index={5}
          />
        </div>
      </div>
